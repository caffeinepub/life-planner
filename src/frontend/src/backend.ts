...
export class Backend implements backendInterface {
    ...
    async addStudy(arg0: Study): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addStudy(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addWorkItem(arg0: WorkItem): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addWorkItem(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStudies(): Promise<Array<Study>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStudies();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getWorkItems(): Promise<Array<WorkItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getWorkItems();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
